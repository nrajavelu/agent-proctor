...
export default function PreExamSetup({ candidateData, onSetupComplete, onCancel }: PreExamSetupProps) {
  ...
  const performFinalTest = async () => {
    ...
    const controlPlaneUrl = `http://localhost:4001/api/v1/sessions/${candidateData.sessionId}/control`;
    ...
    try {
      ...
      console.error('🚨 DEBUG: This is likely because the Control Plane service is not running on port 4001');
