...
const SERVICES: Omit<ServiceHealth, 'status' | 'latency'>[] = [
  { name: 'Session Manager', url: 'http://localhost:8081', port: 8081 },
  { name: 'Control Plane', url: 'http://localhost:4001', port: 4001 },
  { name: 'Quiz App', url: 'http://localhost:3001', port: 3001 },
  { name: 'Admin Dashboard', url: 'http://localhost:3003', port: 3003 },
